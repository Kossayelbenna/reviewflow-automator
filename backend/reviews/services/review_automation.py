...
class ReviewAutomationService:
    """Service for automating the posting of reviews"""
    ...
    async def post_google_review(self, review):
        ...
        try:
            ...
            async with async_playwright() as p:
                ...
                # Login to Google (this is a placeholder - actual implementation will be more complex)
                ...
                # Select the rating
                await self._select_google_rating(page, review.rating)
    ...
    async def post_trustpilot_review(self, review):
        ...
        str: Error message if failed
        """
        # Similar implementation as Google reviews, but adapted for Trustpilot
    ...
    async def _select_google_rating(self, page, rating):
        """
